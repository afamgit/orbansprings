...
import { fetchFilteredRequestsPlumbing } from '../utils/data';
import moment from 'moment';
import { statusBg } from '../utils/snippets';
import Link from 'next/link';

export default async function RequestsPlumbing({
    query,
    currentPage,
    product,
    status,
    ...
    const getRequests = await fetchFilteredRequestsPlumbing(query, currentPage, product, status, location);
...
<h2 className="text-3xl">Plumbing Requests</h2>
         </div> 
