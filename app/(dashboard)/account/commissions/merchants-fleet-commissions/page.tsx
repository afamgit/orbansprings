...
import { fetchMerchantsFleetCommissions, fetchVendors, fetchVendorsCommissions } from '@/app/utils/data'
...
import MerchantsFleetCommissions from '@/app/ui/merchants-fleet-commission'


export const metadata: Metadata = {
  title: 'Commissions | Merchants Fleet',
};
      ...
      <div className='w-full flex justify-end items-start'>
           <Breadcrumbs
            breadcrumbs={[
              ...
              { label: 'Merchants Fleet', href: '/account/commissions/merchants-fleet-commissions', active: true },                            
            ]}
            />
            </div>
            ...
            <Link className='text-3xl text-gray-900 font-medium px-2' href='/account/commissions/merchants-fleet-commissions'>Merchants (Fleet)</Link>
            ...
            <h2 className='text-3xl'>Overall Merchants Fleet Commission</h2>
          </div>

         <MerchantsFleetCommissions query={query} currentPage={currentPage} fType={fType} fSubType={fSubType} />
