...
import { fetchCustomerOrders, fetchDriverOrders, fetchUsers } from "@/app/utils/data";
          ...
          <div className="flex justify-start items-center">
            ...
            <div className="w-3/4 p-2">
              <div className="w-full flex justify-between items-center">
                ...
                <p><DriverDropdown id={id} drvStatus={user?.isavailable || true} /></p>
              </div>

              <div className="w-full flex justify-between items-center">
                <p className="text-gray-600 text-xl">{user?.drv_vehicle_license_plate_no}</p>
...
<div className="w-full flex justify-between items-center text-2xl my-2 p-2">
    <div className="w-1/3">Meter Number<p className="text-xl font-medium">{meterNumber(driverName)}</p></div>
    <div className="w-1/3">Meter Status<p className="text-xl font-medium">{meterStatus(driverName)}</p></div>
    <div className="w-1/3">User Status<p className="text-xl font-medium">{user?.subscription_plan}</p></div>
</div>
