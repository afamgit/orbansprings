...
export async function HomeServices() {
  ...
  return (
    <div className="text-dark">
                <h1 className='text-3xl font-bold text-center my-2 py-2'>What We Offer</h1>
                <h3 className='text-center mb-3'>We deliver technology-backed solutions for efficient water accessibility, water distribution and water management</h3>

        <div className='w-full md:w-[1200px] mx-auto flex justify-center items-center flex-wrap bg-gray-100'>
        {services.map((item,i) => {
          return <div className='px-1 py-3 flex flex-col justify-center items-center w-[320px] h-[400px] mx-7 my-3 rounded' key={i}>
            ...
            <div className='flex flex-col justify-start items-center my-2 h-[300px]'>
                <h3 className='font-bold text-2xl my-2 py-2'>{item.name}</h3>
                <p className='text text-gray-600 text-center'>{item.desc}</p>
            </div>
          </div>
        })}
      </div>
