...
function GenerateButton() {
    ...
    return (
      <button type="submit" aria-disabled={pending} className='p-2 bg-blue-300 my-2 rounded'>
        Generate
      </button>
    )
  }
  ...
  export function UpdateMeterForm({meter, customers}) {
   ...
   const [state, formAction] = useFormState(updateMeterWithId, initialState)
   ...
   return (
    ...
    <div>
        <label htmlFor="uniqueid" className="block text-sm font-medium leading-6 text-gray-900">Meter Number</label>
          <div className="mt-2">
          <input 
            type="text" 
            id="uniqueid" 
        ...
        <div>
        <label htmlFor="assignedto" className="block text-sm font-medium leading-6 text-gray-900">Assigned to</label>
          <div className="mt-2">
          <select 
            type="text" 
            id="assignedto" 
  ...
  export function AddMeterGenerateForm() {
    const [state, formAction] = useFormState(createMeterNumber, initialState)
    ...
    <form action={formAction}>
        <div>
        <label htmlFor="qty" className="block text-sm font-medium leading-6 text-gray-900">No of meter numbers to generate</label>
          <div className="mt-2">
          <select 
            type="text" 
            id="qty" 
