...
export const BottomAppBannerHorizontal = () => {
    return (
        ...
        <div className='bg-sky-500 w-full max-w-[1100px] md:h-[300px] md:max-h-[300px] md:px-8 mx-auto rounded-3xl flex flex-col justify-center items-center md:flex-row md:justify-between md:items-end'>
          ...
          <div className='basis-1/3 flex mb-[-10px] pb-0'>
          <Image
              src='/worker_2.png'
              width={350}
              height={450}
