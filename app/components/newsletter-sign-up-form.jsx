...
export function NewsletterSignup () {
  ...
  return (
    <form action={formAction}>
        <h3 className='my-2 py-2 text-3xl'>Newsletter Sign Up</h3>
        <div className='flex justify-start items-center'>
            <div className='h-[40px]'>
            <input type="text" id="newsletteremail" name="newsletteremail"  placeholder='Email' required className='px-2 py-1 bg-black border border-slate-300 h-[40px]' />
            </div>
            <SignUpButton />
        </div>
